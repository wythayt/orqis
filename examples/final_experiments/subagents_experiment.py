...
SUBAGENT_CANDIDATES = [
    ...
    CandidateConfig(
        ...
        DATASET_RANGE,
        "Same partitioning as IR-B but with reduced identity and network tiers under the cost-oriented SLO profile.",
        [
            ws("p_ingest_alert_plan_response_fanout", 512, timeout_sec=5),
            ws("p_identity_subagent", 512, timeout_sec=30, concurrency_limit=1),
            ws("p_network_subagent", 512, timeout_sec=300, concurrency_limit=1),
            ws("p_communications_subagent", 512, timeout_sec=15, concurrency_limit=1),
            ws("p_synthesize_recommendation", 512, timeout_sec=15),
            ws("p_finalize_incident", 256, timeout_sec=3),
        ],
    ...
    CandidateConfig(
        ...
        [512, 512, 512, 512, 512, 256],
        DATASET_RANGE,
        "Reliability-oriented rerun keeps the compiler partitioning while reducing delegated workers to the lower tier.",
        [
            ws("p_ingest_alert_plan_response_fanout", 512, timeout_sec=5),
            ws("p_identity_subagent", 512, timeout_sec=30, concurrency_limit=1),
            ws("p_network_subagent", 512, timeout_sec=300, concurrency_limit=1),
