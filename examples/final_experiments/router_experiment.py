...
ROUTER_CANDIDATES = [
    ...
    CandidateConfig(
        ...
        [256, 512, 512, 512, 256],
        ROUTER_DATASET_RANGE,
        "Same partitioning as RT-B but lower identity and vendor tiers under the cost-oriented SLO profile.",
        [
            ws("p_intake_request_triage_request_fanout", 256, timeout_sec=5),
            ws("p_billing_specialist", 512, timeout_sec=20),
            ws("p_identity_specialist", 512, timeout_sec=25),
            ws("p_vendor_security_specialist", 512, timeout_sec=180),
            ws("p_finalize_response", 256, timeout_sec=3),
        ],
    ...
    CandidateConfig(
        ...
        [512, 512, 512, 512, 256],
        ROUTER_DATASET_RANGE,
        "Reliability pressure raises the fused dispatch worker while keeping the vendor branch above the lowest tier.",
        [
            ws("p_intake_request_triage_request_fanout", 512, timeout_sec=5),
            ws("p_billing_specialist", 512, timeout_sec=20),
            ws("p_identity_specialist", 512, timeout_sec=25),
            ws("p_vendor_security_specialist", 512, timeout_sec=180),
            ws("p_finalize_response", 256, timeout_sec=3),
